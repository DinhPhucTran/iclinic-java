				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Danh sách giấy nhập viên</h3>
						</div>
					</div>
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="x_content">
								<table id="table-user"
									...
									<tbody>
										<c:forEach items="${dsGiayNhapVien}" var="gnv">
											<tr>
												<td>${gnv.benhNhan.tenBenhNhan}</td>
												<td>${gnv.benhNhan.gioiTinh}</td>
												<td>${gnv.benhNhan.tuoi}</td>
												<td>${gnv.date}</td>
												<td>${gnv.nhanVienTiepNhan.fullName}</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
